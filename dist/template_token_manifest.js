...
exports.TEMPLATE_FIELD_RULES = [
    ...
    { id: "insurance_expiry", anchor: "Certificate of Insurance", targetType: "paragraph", resolverKey: "insurance_expiry", fallback: "Not available" },
    { id: "reserve_study_completed", anchor: "The most recent Reserve Fund Stud was completed on", targetType: "paragraph", resolverKey: "reserve_study_date", fallback: "Not available" },
    { id: "reserve_study_next_due", anchor: "The next Reserve Fund Study is expected to be completed by", targetType: "paragraph", resolverKey: "reserve_study_next_due", fallback: "Not available" },
    { id: "pet_summary", anchor: "3.1", targetType: "paragraph", resolverKey: "pet_summary", fallback: "Not available" },
    { id: "leasing_summary", anchor: "3.2", targetType: "paragraph", resolverKey: "leasing_summary", fallback: "Not available" },
    { id: "permitted_use_summary", anchor: "3.3", targetType: "paragraph", resolverKey: "permitted_use", fallback: "Not available" },
    { id: "additional_items", anchor: "Additional Items to Note:", targetType: "paragraph", resolverKey: "additional_items", fallback: "NONE" }
];
